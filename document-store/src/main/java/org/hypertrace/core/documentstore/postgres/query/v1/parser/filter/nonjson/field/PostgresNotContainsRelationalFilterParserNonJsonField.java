...
/**
 * Implementation of NOT_CONTAINS operator for non-JSON fields (regular PostgreSQL arrays). Uses the
 * PostgreSQL array containment operator (@>) with NOT for checking if one array does not contain
 * another.
 *
 * <p>This class is optimized for first-class array columns rather than JSON document fields.
 */
public class PostgresNotContainsRelationalFilterParserNonJsonField
  ...
  public String parse(
    ...
    return String.format("NOT(%s @> ARRAY[?]::text[])", parsedLhs);
  }
