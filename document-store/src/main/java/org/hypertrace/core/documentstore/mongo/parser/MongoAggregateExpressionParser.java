...
@NoArgsConstructor
final class MongoAggregateExpressionParser extends MongoSelectableExpressionParser {
  ...
  MongoAggregateExpressionParser(final MongoSelectableExpressionParser baseParser) {
    super(baseParser);
  }
