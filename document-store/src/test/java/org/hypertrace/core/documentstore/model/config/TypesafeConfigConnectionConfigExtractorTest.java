...
class TypesafeConfigConnectionConfigExtractorTest {
    ...
    assertThrows(
        ...
        () ->
            TypesafeConfigConnectionConfigExtractor.from(
                ConfigFactory.parseString(""), (String) null));
    assertThrows(
        NullPointerException.class,
        () ->
            TypesafeConfigConnectionConfigExtractor.from(
                ConfigFactory.parseString(""), (DatabaseType) null));
  }
  ...
  void testAllEmpty(final DatabaseType type) {
    final ConnectionConfig config =
        TypesafeConfigConnectionConfigExtractor.from(ConfigFactory.parseString(""), type).extract();
