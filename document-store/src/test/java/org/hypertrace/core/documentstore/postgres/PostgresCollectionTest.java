...
public class PostgresCollectionTest {
  ...
  public void testParseNonCompositeFilter() {
    {
      ...
      String query = collection.parseNonCompositeFilter(filter, initParams(), null);
    ...
    String expectedMessage = collection.UNSUPPORTED_QUERY_OPERATION;
    {
      ...
      Exception exception =
          assertThrows(
              ...
              () -> collection.parseNonCompositeFilter(filter, initParams(), null));
  ...
  public void testParseQueryForCompositeFilterWithNullConditions() {
    {
      ...
      Assertions.assertNull(collection.parseFilter(filter, initParams(), null));
    }
    {
  ...
  public void testParseQueryForCompositeFilter() {
    {
      ...
      String query = collection.parseCompositeFilter(filter, initParams(), null);
  ...
  public void testParseNestedQuery() {
    ...
    String query = collection.parseFilter(filter, initParams(), null);
