...
class SubQueryJoinExpressionTest {
  ...
  void exampleUsage() {
    ...
    */
    Query subQuery =
        Query.builder()
            .addSelection(SelectionSpec.of(IdentifierExpression.of("suite_id"), "suite_id"))
            .addSelection(
                SelectionSpec.of(
                    AggregateExpression.of(
                        AggregationOperator.MAX, IdentifierExpression.of("scan_run_number")),
                    "latest_scan_run_number"))
            .addAggregation(IdentifierExpression.of("suite_id"))
            .build();
